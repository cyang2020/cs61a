...
(begin 1 2 3 4 5 6 7 8 9 61)
;expect 61 

(begin 1 2 3 (undefined_function stop))
;expect Error
...
(lambda (x y) (- x y) (+ x y))
;expect (lambda (x y) (- x y) (+ x y))

((lambda (x y) (- x y) (+ x y)) 1 2)
;expect 3

(define triple_lambda (lambda (x) (* x 3)))
;expect triple_lambda
(triple_lambda 1)
;expect 3 

(define (triple_lambda x) (* x 3))
;expect triple_lambda 
(triple_lambda 1)
;exxpect 3 

(define (super_x x) (* x 999999999999999999999))
;expect super_x 
super_x
;expect (lambda (x) (* x 999999999999999999999))


(eq? (define f (lambda (x) (* x 2))) (define (f x) (* x 2)))
;expect True 
